...
export default function NavBar({ handleReset }) {
  ...
  return (
    <div className="navbar">
      <div className="title">
        <h1>
          {windowWidth <= 1024 ? "GifMatch" : "GifMatch (Boonie Bears ver.)"}
        </h1>
      </div>
      <div className="icons">
        <img src={rotateRight} alt="Rotate Right Icon" onClick={handleReset} />
        <img src={info} alt="Info Icon" onClick={handleInfoClick} />
      </div>
      ...
      {showInfo && (
        <div className="modal">
          <div className="modal-content">
            ...
            <p>
              GifMatch is a fun card matching game where you flip cards to find
              matching GIFs! Match all pairs to win the game!
            </p>
            <p>Hope you enjoy playing it!</p>
            <div className="credits">
              <img src={copyRight} alt="Copy Right Icon" />
